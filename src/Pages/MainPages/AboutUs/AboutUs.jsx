...
const AboutUs = () => {
    return (
        <Container>
            <div className="py-12 md:py-16 lg:py-24 text-base-content">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="bg-base-200 shadow-lg border-l-4 border-primary rounded-xl p-6 md:flex items-center gap-8">
                        {/* Developer Photo */}
                        <img
                        ...
                        <div className="mt-6 md:mt-0">
                            ...
                            <div className="flex gap-4 mt-4">
                                <a
                                    ...
                                    className="text-base-content/80 hover:text-black text-xl"
                                >
                                    <FaGithub />
                                </a>
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-base-content/80 hover:text-blue-700 text-xl"
                                >
                                    <FaGlobe />
                                </a>
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-base-content/80 hover:text-blue-600 text-xl"
                                >
                                    <FaLinkedin />
                                </a>
                            </div>
