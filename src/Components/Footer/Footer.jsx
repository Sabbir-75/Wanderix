...
const Footer = () => {
    return (
        ...
        }} className="px-4 divide-y text-neutral-content">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row gap-4 lg:space-y-0">
                <div className="lg:w-1/3 flex flex-col gap-4 justify-center items-center">
                    <img className='max-w-[230px]' src={FooterLogo} alt={FooterLogo} />
                    ...
                    <div className="join">
                        <div className='flex items-center bg-base-100 px-2 rounded-l-sm'>
                            ...
                            <input
                                ...
                                className="input px-2 input-bordered outline-0 focus:outline-0 border-none join-item text-black" />
                        </div>
