...
const Footer = () => {
    return (
        ...
        }} className="divide-y text-neutral-content py-8 md:py-12 lg:py-16">
            <Container>
                <div className="flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row gap-4 lg:space-y-0">
